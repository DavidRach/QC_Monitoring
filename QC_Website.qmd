This document was the original testing ground. The R code below has been copied to QC_UpdateData.R to be used in the dashboard as part of a Source call. 
